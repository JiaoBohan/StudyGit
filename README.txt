...
git remote add <origin> git@server-name:server-user-name/repo-name.git    // 关联远程库     origin 为给远程库指定的名字
//  git@server-name:path/repo-name.git 如 git@github.com:michaelliao/learngit.git
